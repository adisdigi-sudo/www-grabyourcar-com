...
const SCHEMA = {
  ...
  properties: {
    specs: {
      type: 'object',
      description: 'Key technical specs. Provide as many fields as you know.',
      properties: {
        mileage: { type: 'string', description: 'e.g. 20.5 kmpl or 450 km range' },
        engine_cc: { type: 'string', description: 'e.g. 1498 cc or "Electric"' },
        max_power: { type: 'string', description: 'e.g. 120 bhp @ 6000 rpm' },
        max_torque: { type: 'string', description: 'e.g. 200 Nm @ 3000 rpm' },
        seating_capacity: { type: 'string', description: 'e.g. 5' },
        fuel_tank: { type: 'string', description: 'e.g. 45 litres' },
        boot_space: { type: 'string', description: 'e.g. 385 litres' },
        ground_clearance: { type: 'string', description: 'e.g. 170 mm' },
        length: { type: 'string', description: 'e.g. 4395 mm' },
        width: { type: 'string', description: 'e.g. 1735 mm' },
        height: { type: 'string', description: 'e.g. 1500 mm' },
        wheelbase: { type: 'string', description: 'e.g. 2570 mm' },
        kerb_weight: { type: 'string', description: 'e.g. 1100 kg' },
        top_speed: { type: 'string', description: 'e.g. 180 kmph' },
        acceleration: { type: 'string', description: '0-100 e.g. 9.8 sec' },
        drivetrain: { type: 'string', description: 'e.g. FWD/RWD/AWD/4WD' },
        airbags: { type: 'string', description: 'e.g. 6' },
        ncap_rating: { type: 'string', description: 'e.g. 5 stars' },
      },
    },
    variants: {
      type: 'array',
