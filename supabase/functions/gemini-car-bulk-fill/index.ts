...
const SCHEMA = {
  ...
  properties: {
    specs: {
      type: 'object',
      description: 'REQUIRED: Key technical specs. Always provide at least mileage, engine_cc, max_power, seating_capacity for any car.',
      properties: {
        mileage: { type: 'string' },
        ...
        airbags: { type: 'string' },
        ncap_rating: { type: 'string' },
      },
      required: ['mileage', 'engine_cc', 'max_power', 'seating_capacity'],
    },
    variants: {
      type: 'array',
