...
export async function generateBulkQuoteExcel(prefilledLeads?: PrefilledLead[]) {
  ...
  const instructions = [
    ...
    "",
    "NCB AUTO-CALCULATOR (Year-wise):",
    "  If NCB% (Col O) is left empty, it auto-calculates from Vehicle Year:",
    "  ┌────────────────┬──────────┐",
    "  │ Vehicle Age    │ NCB %    │",
    "  ├────────────────┼──────────┤",
    "  │ 0 (New Car)    │ 0%       │",
    ...
    "  │ 5+ Years       │ 50%      │",
    "  └────────────────┴──────────┘",
    "  You can override by entering NCB% manually in column O.",
    "",
    "PREMIUM FORMULAS:",
    "  OD Discount Amt = Basic OD × OD Discount%",
    "  OD After Discount = Basic OD - OD Discount Amt",
    "  NCB Discount = OD After Discount × NCB%  ← applied AFTER OD discount",
