     ...
     <Card className="border-2 border-success/30 shadow-xl overflow-hidden bg-gradient-to-br from-card via-card to-success/5">
       <CardHeader className="pb-3 bg-gradient-to-r from-success/10 via-primary/5 to-success/10 border-b border-border/50">
         <CardTitle className="flex items-center gap-2 text-lg">
           <div className="w-9 h-9 rounded-full bg-gradient-to-br from-success to-success/70 flex items-center justify-center shadow-md">
           ...
           <Badge variant="trust" className="text-xs animate-pulse">
       ...
       <CardContent className="pt-5 pb-5">
         <form onSubmit={handleBookingSubmit} className="space-y-4">
           ...
           <div className="flex flex-col gap-2 pt-3 border-t border-border/50">
             ...
             <div className="flex items-center gap-2 text-xs text-muted-foreground">
               <CheckCircle className="h-3.5 w-3.5 text-success" />
               <span>🔒 Your information is 100% safe & secure</span>
             </div>
           </div>
         </form>
       </CardContent>
