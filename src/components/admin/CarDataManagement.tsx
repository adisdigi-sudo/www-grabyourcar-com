...
export const CarDataManagement = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Car Data Management</h1>
        ...
        <TabsContent value="status" className="space-y-6">
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                <Button onClick={() => refetchCars()} variant="outline" size="sm" className="w-full">
            ...
            <CardContent>
              {carsLoading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>No cars in database yet. Use the Migration tool to import static data.</p>
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <TabsContent value="enhance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Use AI to generate or improve car data
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="validation">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Check for stale data and missing information
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <Button
...
export default CarDataManagement;
