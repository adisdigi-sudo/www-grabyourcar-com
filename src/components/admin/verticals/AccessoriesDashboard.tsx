...
import { Package, ShoppingCart, TrendingUp, IndianRupee, Tags, FileText, Star } from "lucide-react";
...
export const AccessoriesDashboard = () => {
  ...
  const kpis = [
    ...
    { label: "Pending", value: stats?.pendingOrders || 0, icon: Package, color: "text-amber-500" },
    { label: "Revenue", value: "—", icon: IndianRupee, color: "text-green-500" },
    { label: "Avg Order Value", value: "—", icon: TrendingUp, color: "text-primary" },
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Products, orders, and cross-sell management</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-3">
          {[
            ...
            { label: "View Orders", icon: FileText },
            { label: "Cross-Sell Rules", icon: Tags },
          ].map((a) => (
