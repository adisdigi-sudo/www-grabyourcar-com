...
const navItems: NavItem[] = [
  ...
  { id: "live-chats", label: "💬 Live Chats", icon: MessageCircle, badge: "Live", allowedRoles: ["super_admin", "admin"] },
  ...
  { 
    ...
    children: [
      ...
      { id: "services-messaging-channels", label: "📡 Messaging & Channels", icon: Globe, verticals: [], allowedRoles: ["super_admin", "admin"] },
  ...
  { 
    ...
    children: [
      ...
      { id: "website-pdf-branding", label: "PDF Branding (Global)", icon: FileText },
      { id: "website-pdf-vertical-settings", label: "PDF per Vertical", icon: FileText },
